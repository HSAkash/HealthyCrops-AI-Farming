...
class CropDiseaseML:
    def __init__(self):
        banana_model = tflite.Interpreter('crop/ML_deseases/tfliteModels/banana.tflite')
        potato_model = tflite.Interpreter('crop/ML_deseases/tfliteModels/potato.tflite')
        tomato_model = tflite.Interpreter('crop/ML_deseases/tfliteModels/tomato.tflite')
        guava_model = tflite.Interpreter('crop/ML_deseases/tfliteModels/guava.tflite')
        cauliflower_model = tflite.Interpreter('crop/ML_deseases/tfliteModels/cauliflower.tflite')
        self.model_dict = {
